...
def chatbot(request):
    ...
    if request.method == "POST":
        ...
        combined_input = (
                ...
                + "\n\nPlease provide a very concise answer in a simple language considering the above documents only and show the source. "
                  "If the answer is not found, respond with '''Content Not found'''."
        )
